<template>
	<view class="order-li">
		...
		<view class="li-bottom">
			<view class="img-box">
				<image :src="setImgUrl_100(props.item?.goodsInfo[0].coverPicUrl)" mode="aspectFit" />
				<image class="img-icon" :src="setFileFormat(props.item?.goodsInfo[0].goodsType)" mode="widthFix"></image>
			</view>
